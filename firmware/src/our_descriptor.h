...
#define V_RESOLUTION_MULTIPLIER_MASK (1 << 0)
#define H_RESOLUTION_MULTIPLIER_MASK (1 << 2)
#define DEFAULT_RESOLUTION_MULTIPLIER (V_RESOLUTION_MULTIPLIER_MASK | H_RESOLUTION_MULTIPLIER_MASK)
